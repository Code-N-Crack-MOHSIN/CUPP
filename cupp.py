...
def print_cow():
    print(" ___________ ")
    print(" \033[07m  cupp By Mohsin! \033[27m                # \033[07mC\033[27mommon")
    ...
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ This file is Modified by MOhsin]"
    )
    print(28 * " " + "[ Instagram @code_n_crack]\r\n")
